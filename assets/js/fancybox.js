							...
							(o.style.visibility = "hidden"),
								...
								(n.onload = function () {
									...
									n.isReady || ((n.isReady = !0), (o = !0)),
										n.src.length &&
											((n.parentNode.style.visibility = ""), e.resizeIframe(t), o && i.revealContent(t));
								}),
					...
					value: function (t) {
						...
						if (!(t.isDom || t.html || (t.type && "image" !== t.type) || t.$image)) {
							...
							n.addEventListener("load", function (i) {
								...
								(n.src = t.src),
								(n.alt = "<?php echo get_bloginfo('name'); ?>"),
								(n.draggable = !1),
								...
								try {
									for (n.s(); !(e = n.n()).done; ) {
										...
										if (!r) {
											...
											l &&
												(r = l instanceof HTMLImageElement ? l : l.querySelector("img:not([aria-hidden])")),
												!r &&
													o.$trigger &&
													(r =
									...
									if (n && !t.ctrlKey && !t.altKey && !t.shiftKey) {
										...
										if ("Escape" !== e && !s)
											if (
												...
												-1 !==
													["BUTTON", "TEXTAREA", "OPTION", "INPUT", "SELECT", "VIDEO"].indexOf(o.nodeName)
											)
												return;
